    ...
    <div className="space-y-10 pb-20">
      ...
      {history.length === 0 ? (
        <div className="text-center py-20 space-y-4">
          ...
          <button onClick={() => onNavigate('LIBRARY')} className="text-primary hover:underline inline-block">Kütüphaneye Göz At</button>
        </div>
      ) : (
            ...
            {history.map((item, index) => (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-5 rounded-2xl bg-[#121212] border border-white/10 hover:bg-[#1c1c1e] transition-all group"
                >
